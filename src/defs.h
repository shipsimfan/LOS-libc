...
#define SYSTEM_CALL_CHANGE_DIRECTORY 13
#define SYSTEM_CALL_GET_DIR_ENT_NUM 14
#define SYSTEM_CALL_GET_DIR_ENT 15
#define SYSTEM_CALL_GET_CURRENT_TIME 16
#define SYSTEM_CALL_TRUNCATE 17
